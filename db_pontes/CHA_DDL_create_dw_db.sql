DROP SCHEMA IF EXISTS dw_cha CASCADE;
CREATE SCHEMA dw_cha;
...
CREATE TABLE Vendedor_PONTE
(
  tv_SK BIGINT NOT NULL,
  cl_SK BIGINT NOT NULL,

  PRIMARY KEY (tv_SK, cl_SK),
  FOREIGN KEY (tv_SK) REFERENCES Trans_Venda_FACT(tv_SK),
  FOREIGN KEY (cl_SK) REFERENCES Cliente_DIMENSION(cl_SK)
);

CREATE TABLE Comprador_PONTE
(
  tv_SK BIGINT NOT NULL,
  cl_SK BIGINT NOT NULL,
